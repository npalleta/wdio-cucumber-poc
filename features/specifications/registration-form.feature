...
Scenario: Access the customer registration page and fill out the customer registration type individual
    ...
    And Fill the new user text box/ email text box with "emailtest@test.com"
    ...
    And Fill in the confirmation email text box with "emailtest@test.com"
    ...
    And Fill in the cpf text box with "58293119179"
